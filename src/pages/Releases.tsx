    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
      {sets.map((s) => {
        ...
        return (
          ...
          >
            {/* Adjusted aspect ratio for 818x1288 images */}
            <div className="w-full aspect-[818/1288] overflow-hidden rounded-xl mb-3">
              <img
                src={s.coverImage}
                alt={`${s.name} cover`}
            ...
            <div className="font-semibold text-lg">{s.code} {s.name}</div>
            {s.releaseDate && (
            ...
            {/* Faux button for visual consistency */}
            <span
